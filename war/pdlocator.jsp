<%@ include file = "header1.jsp" %>
		<title>Pediatrician Locator | VacciIndia</title>
			...
			<div role="main" class="main">
				...
				<section class="page-header page-header-color page-header-primary page-header-float-breadcrumb">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h1 class="mt-xs">Pediatrician Locator <span>To find nearby pediatricians clinics.</span></h1>
								<ul class="breadcrumb breadcrumb-valign-mid">
									<li><a href="home">Home</a></li>
									<li class="active">Pediatrician Locator</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-4">
								...
								<h5>To find nearby Pediatricians.</h5>
