...
<%@ include file = "../header2.jsp" %>
						...
						<div id="revolutionSlider" class="slider rev_slider" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 560}">
							<ul>
								<li data-transition="fade">
									<img src="img/slides/slide-title-border-3.jpg"
										alt=""
									...
									<div class="tp-caption top-label"
										...
										data-y="190"
										data-start="500"
										data-transform_in="y:[-300%];opacity:0;s:500;">ALL YOU NEED IS</div>
					...
					<div class="row center">
						<div class="col-md-12">
							<h1 class="mb-sm word-rotator-title">
								...
								is one of the many services we provide.
							</h1>
							<p class="lead">
								The mission of the Vacci-India is to help internet users find reliable vaccine safety information for their babies as per their needs. It also aims at reducing the time for vaccines to reach child living in poor areas. More than two million children die each year from diseases which can be prevented.
							</p>
						</div>
					</div>
							...
							<div class="col-md-2 col-md-offset-1">
								<div class="process-image">
									<div class="box-image">
										...
										<img src="images/about1.png" alt="" class="appear-animation" data-appear-animation="zoomIn" data-appear-animation-duration="300" data-appear-animation-delay="1400" />
									</div>
									<strong class="appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="1150" data-plugin-options="{'accY': 200}">About Us</strong>
								</div>
							</div>
							<div class="col-md-2">
								<div class="process-image">
									<div class="box-image">
										...
										<img src="images/contact2.jpg" alt="" class="appear-animation" data-appear-animation="zoomIn" data-appear-animation-duration="300" data-appear-animation-delay="1900" />
									</div>
									<strong class="appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="2150" data-plugin-options="{'accY': 200}">Contact Us</strong>
								</div>
							</div>
							<div class="col-md-2">
								<div class="process-image">
									<div class="box-image">
										...
										<img src="images/asd.jpg" alt="" class="appear-animation" data-appear-animation="zoomIn" data-appear-animation-duration="300" data-appear-animation-delay="2400" />
									</div>
									<strong class="appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="2650" data-plugin-options="{'accY': 200}">Vaccines</strong>
								</div>
							</div>
								...
								<div class="project-image">
									<div class="box-image">
										...
										<div id="fcSlideshow" class="fc-slideshow appear-animation" data-appear-animation="zoomIn" data-appear-animation-duration="300" data-appear-animation-delay="2900">
											<ul class="fc-slides">
												<li><a href=""><img class="img-responsive" src="images/s1.png" alt="" /></a></li>
												<li><a href=""><img class="img-responsive" src="images/s2.jpg" alt="" /></a></li>
												<li><a href=""><img class="img-responsive" src="images/s3.jpg" alt="" /></a></li>
											</ul>
										</div>
									</div>
			...
			<section class="section">
				<div class="container">
					<div class="row mt-md">
						<div class="col-md-12">
							<h2 class="font-weight-semibold m-none">Services</h2>
							<p class="lead font-weight-normal">List of Services we provide at Vacci-India.</p>
						</div>
					</div>
							...
							<a href="vaccine-bcg" class="text-decoration-none">
								<span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
									<span class="thumb-info-side-image-wrapper">
										<img alt="" class="img-responsive" src="images/sch.jpg">
									</span>
									<span class="thumb-info-caption">
										<span class="thumb-info-caption-text p-xl">
											<h4 class="font-weight-semibold mb-xs">Vacci-Scheduler</h4>
											<p>Get a customised vaccine chart for your baby.</p>
										</span>
									</span>
								</span>
							</a>
						...
						<div class="col-sm-3 col-md-3">
							<a href="vaccine-dtp" class="text-decoration-none">
								<span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
									<span class="thumb-info-side-image-wrapper">
										<img alt="" class="img-responsive" src="images/loc.jpg">
									</span>
									<span class="thumb-info-caption">
										<span class="thumb-info-caption-text p-xl">
											<h4 class="font-weight-semibold mb-xs">Vacci-Locator</h4>
											<p>Locate nearby hospitals to get your child vaccinated.</p>
										</span>
									</span>
								</span>
							</a>
						...
						<div class="col-sm-3 col-md-3">
							<a href="vaccine-hepb" class="text-decoration-none">
								<span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
									<span class="thumb-info-side-image-wrapper">
										<img alt="" class="img-responsive" src="images/rem.jpg">
									</span>
									<span class="thumb-info-caption">
										<span class="thumb-info-caption-text p-xl">
											<h4 class="font-weight-semibold mb-xs">Vacci-Reminder</h4>
											<p>Get reminders on vaccine date via your mail.</p>
										</span>
									</span>
								</span>
							</a>
						...
						<div class="col-sm-3 col-md-3">
							<a href="vaccine-hepb" class="text-decoration-none">
								<span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
									<span class="thumb-info-side-image-wrapper">
										<img alt="" class="img-responsive" src="images/ath.jpg">
									</span>
									<span class="thumb-info-caption">
										<span class="thumb-info-caption-text p-xl">
											<h4 class="font-weight-semibold mb-xs">Vacci @ Home</h4>
											<p>Get your child vaccinated at your home.</p>
										</span>
									</span>
								</span>
							</a>
				...
				<div class="container">
					<div class="row pt-xl">
						<div class="col-md-12">
							<h2 class="font-weight-semibold mb-xs">Vaccinations</h2>
							<p class="lead font-weight-normal">Know about the recommended vaccinations for your child.</p>
						</div>
					</div>
					<div class="row mt-lg">
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2 mb-xl appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								...
								<div class="feature-box-info ml-md">
									...
									<p>BCG vaccine is a vaccine primarily used against tuberculosis.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2 mb-xl appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								...
								<div class="feature-box-info ml-md">
									...
									<p>Hep-B vaccine protects against many liver cancers.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2 mb-xl appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								...
								<div class="feature-box-info ml-md">
									...
									<p>Children get polio vaccine to protect against poliomyelitis.</p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2 mb-xl appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								...
								<div class="feature-box-info ml-md">
									...
									<p>DTaP vaccine protects your child against diphtheria, tetanus and pertussis</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2 mb-xl appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								...
								<div class="feature-box-info ml-md">
									...
									<p>Haemophilus influenzae type B protects from a serious form of pneumonia, and a disease called bacterial meningitis.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2 mb-xl appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								...
								<div class="feature-box-info ml-md">
									...
									<p>Vaccination can protect both children and adults from pneumococcal disease.</p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2 mb-xl appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								...
								<div class="feature-box-info ml-md">
									...
									<p>Rotavirus is the most common cause of serious diarrhea in babies and young children.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2 mb-xl appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								...
								<div class="feature-box-info ml-md">
									...
									<p>The vaccine protects against three diseases: measles, mumps, and rubella.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="feature-box feature-box-style-2 mb-xl appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								...
								<div class="feature-box-info ml-md">
									...
									<p>HPV vaccine is important because it protects against cancers caused by human papillomavirus infection.</p>
								</div>
							</div>
						</div>
					</div>
							...
							<div>
								<div class="col-md-8 col-md-offset-2 pt-xlg">
									<div class="testimonial testimonial-style-2 testimonial-with-quotes mb-none">
										...
										<blockquote>
											<p class="font-weight-light">Vaccination is a public health issue because influenza is a highly contagious disease. If you don't vaccinate your child, his or her schoolmates are much more likely to become ill. That is why some places (New York, for example) are making the vaccine mandatory for school children.</p>
										</blockquote>
										<div class="testimonial-author mt-xlg">
											<p class="text-uppercase">
												<strong>Michael Specter</strong>
											</p>
										</div>
									</div>
								</div>
