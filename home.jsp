...
<%@ include file = "header2.jsp" %>
					...
					<ul>
						<li data-transition="fade">
							...
							<div class="tp-caption main-label"
								...
								data-mask_in="x:0px;y:0px;">A calendar for vaccinations</div>
							...
							<div class="tp-caption main-label"
								...
								data-transform_in="y:[-300%];opacity:0;s:500;">Vacci Scheduler</div>
							...
							<div class="tp-caption bottom-label"
								...
								data-transform_in="y:[100%];opacity:0;s:500;" style="font-size: 1.2em;">You can chose to get Notifications.</div>
						</li>
						<li data-transition="fade">
							...
							<div class="tp-caption main-label"
								...
								data-transform_out="opacity:0;s:500;"
								style="z-index: 5; font-size: 1.5em; text-transform: uppercase;"
								data-mask_in="x:0px;y:0px;">To find nearby hospitals which provide vaccinations</div>
							...
							<div class="tp-caption main-label"
								...
								data-start="500"
								style="z-index: 5; text-transform: uppercase; font-size: 52px;"
								data-transform_in="y:[-300%];opacity:0;s:500;">Vacci Locator</div>
							...
							<div class="tp-caption bottom-label"
								...
								data-start="2000"
								style="z-index: 5; border-bottom: 1px solid #fff; padding-bottom: 3px;"
								data-transform_in="y:[100%];opacity:0;s:500;" style="font-size: 1.2em;">You can also locate Pediatricians in case of urgency</div>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="container">
					<div class="row medical-schedules">
						<div class="col-lg-3 box-one background-color-primary appear-animation" data-appear-animation="fadeInLeft" data-appear-animation-delay="0">
							<div class="feature-box feature-box-style-2 p-lg">
								<div class="feature-box-icon">
									<img src="img/demos/medical/icons/medical-icon-heart.png" alt class="img-responsive pt-xs" />
								</div>
								<div class="feature-box-info ml-md">
									<h4 class="m-none">Vaccination India</h4>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 box-four background-color-secondary p-none appear-animation" data-appear-animation="fadeInLeft" data-appear-animation-delay="1800">
							<a href="tel:+919013174700" class="text-decoration-none">
								<div class="feature-box feature-box-style-2 m-none">
									...
									<div class="feature-box-info ml-md">
										...
										<strong class="font-weight-normal">+919013174700</strong>
									</div>
								</div>
							</a>
						</div>
					...
					<div class="row mt-xlg pt-xlg mb-xlg pb-xs">
						<div class="col-sm-8 col-md-8">
							...
							<p class="lead font-weight-normal">We are a one stop solution for all you vaccination needs.</p>

							<p>This portal is a brainchild of a team of five of us who got along to explore the world of java but little did we know the ride we were in for! Somewhere along the way we were made to realize that a true engineer is not who knows something inside-out but rather uses it to some practical objective...</p>

							<a href="about" class="btn btn-borders btn-quaternary custom-button text-uppercase mt-lg mb-lg font-weight-bold">read more</a>
						</div>
						<div class="col-sm-4 col-md-4">
							<img src="images/home-about.jpg" alt class="img-responsive box-shadow-custom" />
						</div>
					</div>
				</div>
			</section>
			...
			<section class="section">
				<div class="container">
					<div class="row mt-md">
						<div class="col-md-12">
							<h2 class="font-weight-semibold m-none">Vaccines</h2>
							<p class="lead font-weight-normal">List of mandotory vaccines for every infant</p>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-4 col-md-4">
								...
								<span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
									...
									<span class="thumb-info-caption">
										<span class="thumb-info-caption-text p-xl">
											...
											<p>Bacillus Calmette–Guérin (BCG) vaccine is a vaccine primarily used against tuberculosis...</p>
										</span>
									</span>
								</span>
							</a>
								...
								<span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
									...
									<span class="thumb-info-caption">
										<span class="thumb-info-caption-text p-xl">
											...
											<p>The DTaP vaccine protects your child against three diseases: diphtheria, tetanus, and pertussis...</p>
										</span>
									</span>
								</span>
							</a>
								...
								<span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
									...
									<span class="thumb-info-caption">
										<span class="thumb-info-caption-text p-xl">
											...
											<p>Hepatitis B vaccine is made from parts of the hepatitis B virus. It protects from causing hepatitis B infection...</p>
										</span>
									</span>
								</span>
							</a>
					...
					<div class="row pb-xlg">
						<div class="col-md-12 center">
							<a class="btn btn-borders btn-quaternary custom-button text-uppercase font-weight-bold" href="vaccines">view more</a>
						</div>
					</div>
				</div>
			</section>
